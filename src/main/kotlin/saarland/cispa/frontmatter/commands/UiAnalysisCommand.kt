...
internal open class UiAnalysisCommand(help: String = "Use this command to run the analysis, more help with -h") : Command(help = help) {
    ...
    private fun uiAnalysis(settings: FrontmatterSettings) {
